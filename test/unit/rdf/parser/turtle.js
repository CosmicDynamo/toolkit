...
define([
    ...
    "jazzHands/rdf/parser/turtle",
    "dojo/when",
    "dojo/promise/all",
    "jazzHands/rdf/Graph",
    "jazzHands/rdf/Triple",
    "jazzHands/test/unit/rdf/graph/compare"
], function (TestPackage, Turtle, when, all, Graph, Triple, compare) {
    new TestPackage({
        prefix: {"rdf-test": "http://www.w3.org/ns/rdftest#"},
        module: "jazzHands/rdf/parser/turtle",
        manifest: "jazzHands/test/unit/rdf/parser/turtle/manifest.ttl",
        ...
        debugId: {
            "jazzHands/test/unit/rdf/parser/turtle/manifest.ttl#turtle-subm-01": true
        },
        excludeById: {
        },
