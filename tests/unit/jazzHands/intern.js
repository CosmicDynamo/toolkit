...
define({
    ...
    environments: [
        { browserName: 'firefox' },
        { browserName: 'chrome', platform: [ 'Windows 7', 'Windows 8' ] },
        { browserName: 'internet explorer', version: '11', platform: ['Windows 7', 'Windows 8'] }
    ],
    ...
    loader: {
        ...
        packages: [
            ...
            { name: 'jazzHands', location: 'src/jazzHands' },
    ...
    suites: [ 'tests/unit/jazzHands/module' ],
